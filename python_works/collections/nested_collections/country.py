...
def get_country_by_name(country_name):
    ...
    return[c for c in countries if c.get('name').lower()==country_name.lower()]

# print(get_country_by_name('uzbekistan'))


# print country capital by name


def get_country_capital(country_name):

    return[c.get('capital') for c in countries if c.get('name').lower()==country_name.lower()]

# print(get_country_capital('china'))




# 1   -  print region of a given country
# 2   -  print all indipendant countries
# 3   -  print all non-indipendant countries
# 4   -  print languages of a given country
# 5   -  print the borders of a given country
# 6   -  print the country with most population
# 7   -  print the country with less population
# 8   -  print countries having population less than 1000000
# 9   -  which region have the most countries
# 10  -  which region have the less countries
# 11  -  print country with most NO OF borders 
# 12  -  print country with less NO OF borders
# 13  -  which country have most languagess
# 14  -  which country have less languagess
# 15  -  Print native name of the given country
...
def get_country_region(country_name):
    ...
    return [c.get('region') for c in countries if (c.get('name').lower())==country_name.lower()]

# print(get_country_region('china'))
...
def indipendent_countries():
    
    return[c.get('name') for c in countries if c.get('independent')==True]

# print(indipendent_countries())
...
def non_indipendent_countries():
    
    return[c.get('name') for c in countries if c.get('independent')==False]

# print(non_indipendent_countries())



# 4   -  print languages of a given country

def country_language(country_name):
    
    return[c.get('languages') for c in countries if (c.get('name').lower())==country_name.lower()]
...
def country_borders(country_name):
    
    return[c.get('borders') for c in countries if (c.get('name').lower())==country_name.lower()]

# print(country_borders('india'))
...
def most_populated_country():
    ...
    count={c.get('name'):c.get('population') for c in countries}
...
# print(less_populated_country())



# 8   -  print countries having population less than 1000000

def population_limit_countries():
    
    count={c.get('name'):c.get('population') for c in countries}

    return [c for c in count if count.get(c)<1000000]

# print(population_limit_countries())
...
def largest_region():
    ...
    all_country=[c.get('region') for c in countries]

    count={c:all_country.count(c) for c in all_country}
...
def smallest_region():
    ...
    sorted_count=sorted(count,key=count.get,reverse=False)
...
def no_of_borders():
    ...
    all_country={c.get('name'):c.get('borders') for c in countries}

    count={c:len(all_country.get(c)) for c in all_country if all_country.get(c)!=None }
...
# 13  -  which country have most languages


# 14  -  which country have less languages
...
def get_native_name(country_name):
    
    return[c.get('nativeName') for c in countries if c.get('name').lower()==country_name.lower()]



# print(get_native_name('india'))


# print population of a given country

def get_population(country_name):
    
    return[c.get('population') for c in countries if c.get('name').lower()==country_name.lower()]
